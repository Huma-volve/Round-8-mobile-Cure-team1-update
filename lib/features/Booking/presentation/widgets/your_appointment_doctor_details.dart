...
class YourAppointmentDoctorDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Jennifer Miller',style: AppTextStyles.georgiaRegular16(context),),
           Text('Psychiatrist',style: AppTextStyles.montserratRegular14(context),),
        ],
       )
       ,
      const Spacer(),
GestureDetector(
  onTap: () {
    context.push(AppRoute.chat);
  },
  child: Image.asset(Assets.resourceImagesMessage))
        ],
      ),
      SizedBox(height: 8.w,),
      const MyBookingDoctorDetailsLocation(docAddress: '',)
      ],
    );
  }
}

...
class _AboutMeSectionState extends State<AboutMeSection> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text('About me',style: AppTextStyles.georgiaRegular20(context),),
        Wrap(
          children: [
            Text(fullText==true?longText:shortText,style: AppTextStyles.georgiaRegular14(context).copyWith(color: ColorsLight.blueGray),),
            if(!fullText)
            GestureDetector(
              onTap: () {
                setState(() {
              ...
              child: Text('Read more',style: AppTextStyles.georgiaRegular14(context).copyWith(color: ColorsLight.royalBlue),))
          ],
        )
      ],
    );

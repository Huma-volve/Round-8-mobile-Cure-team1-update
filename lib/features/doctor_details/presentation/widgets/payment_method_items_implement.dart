...
class PaymentMethodItemsImplement extends StatefulWidget {
  ...
  @override
  State<PaymentMethodItemsImplement> createState() => _PaymentMethodItemsImplementState();
}

class _PaymentMethodItemsImplementState extends State<PaymentMethodItemsImplement> {
  int selecteditem=0;
  @override
    ...
    return  Column(
          children:   paymentItemsList.asMap().entries.map((e){
               ...
               return   GestureDetector(
                ...
                child: PaymentItem(paymendata: e.value, isActiveItem: selecteditem==e.key,));
        }).toList(),
        );
  }
}